        ...
        const newEvents = events.map(event => {
            ...
            if (event_type.startsWith('_email')) {
                const emailEvent = {
                    ...
                    event_timestamp: event.event_timestamp ? moment(event.event_timestamp).format('YYYY-MM-DD HH:mm:ss') : null,
                    arrival_timestamp: event.arrival_timestamp ? moment(event.arrival_timestamp).format('YYYY-MM-DD HH:mm:ss') : null,
